					...
					<div class="col-lg-3 column">
						<div class="widget">
							<div class="about_widget">
								...
								<h1>Jobhun</h1>
								<span>Semua hal yang dibutuhkan para pencari kerja maupun perusahaan yang sedang mencari pekerja ada di Jobhun. Pencari kerja dapat menemukan pekerjaan, sekaligus mengembangkan kemampuannya. Sedangkan perusahaan bisa mencari pekerja dengan cara yang cepat dan mudah.</span>
								<div class="social">
...
<script src="{{asset('user/js/modernizr.js')}}" type="text/javascript"></script>
...
<script src="{{asset('user/js/slick.min.js')}}" type="text/javascript"></script>
<script src="{{asset('user/js/parallax.js')}}" type="text/javascript"></script>
<script src="{{asset('user/js/select-chosen.js')}}" type="text/javascript"></script>
